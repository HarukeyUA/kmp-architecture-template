...
/**
 * Auth domain errors. Login failures deliberately do **not** appear here — unknown-user and
 * wrong-password both collapse to the cross-cutting `Unauthorized` (the information-disclosure
 * boundary).
 */
 ...
 * `EmailTaken` round-trips across the seam.
 */
