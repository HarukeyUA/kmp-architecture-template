 ...
 * set `notes.create` commits to returning, handled exhaustively by the client for that call.
 *
 ...
 * `ErrorEnvelope`, exercising the per-domain error path end-to-end for a second domain.
 */
sealed interface NotesCreateError : ApiError
